\section{问题一：保真约束下的脑电降噪与视觉响应提取}

\subsection{数据组织与事件对齐}
...
\subsection{基础保真预处理模型}

\subsubsection{零相位带通滤波与基线校正}
